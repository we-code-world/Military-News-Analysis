                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <c:forEach  var="item" items="${requestScope.get('pageDetil').list}">
                            <tr>
                                <td>${item.showDate()}</td>
                                <td>${item.accidentEventLocation}</td>
                                <td>${item.accidentEventTrigger}</td>
                                <td><a class="btn btn-success" href="${pageContext.request.contextPath}/Admin/general/Events/Detail"  onclick="seeID(${item.accidentEventID})">查看详情</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
