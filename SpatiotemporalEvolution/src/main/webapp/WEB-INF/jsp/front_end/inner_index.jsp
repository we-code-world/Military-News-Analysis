...
<div class="container marketing">
    ...
    <div class="row">
        ...
        <div class="col-lg-4" hidden>
            <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140px" height="140px">
            <h2>Heading</h2>
...
<script src="${pageContext.request.contextPath}/js/inner_index/bootstrap.min.js"></script>
