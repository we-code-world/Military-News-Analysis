                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach  var="item" items="${requestScope.get('pageDetil').list}">
                            <tr>
                                ...
                                <td><a href="${pageContext.request.contextPath}/Show/News/Detail" onclick="setCookie('pageID',${item.newsID},0.01)">详细分析</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
        ...
        <div class="pagination page-num" value="${requestScope.get('pageDetil').pageNum}">
            <ul>
                <c:if test="${requestScope.get('pageDetil').isFirstPage == false }">
                    <li><a class="last-page btn btn-success" href="${pageContext.request.contextPath}/Show/News">上一页</a>
                    </li>
                </c:if>
                <li><a class="btn btn-default" href="javascript:void(0)">第${requestScope.get('pageDetil').pageNum}页</a></li>
                <c:if test="${requestScope.get('pageDetil').isLastPage == false}">
                    <li><a class="next-page btn btn-success" href="${pageContext.request.contextPath}/Show/News">下一页</a>
                    </li>
                </c:if>
            </ul>
        </div>
