        ...
        <ul>
            <li style="font-size: 14px;">
                <small>时间：
                    ...
                    <span class="label label-danger input-icon-tag-tip-1" style="text-shadow: none;display: none">请认真填写，审核后才能发布</span>
                    &nbsp;
                </small>
            </li>
            <li style="font-size: 14px;">
                <small>地点：
                    ...
                    <span class="label label-danger input-icon-tag-tip-2" style="text-shadow: none;display: none">请认真填写，审核后才能发布</span>
                    &nbsp;
                </small>
            </li>
            <li style="font-size: 14px;">
                <small>武器装备：
                    ...
                    <span class="label label-danger input-icon-tag-tip-3" style="text-shadow: none;display: none">请认真填写，审核后才能发布</span>
                    &nbsp;
                </small>
            </li>
<%--            <li style="font-size: 14px;">--%>
...
<%--            </li>--%>
            <li style="font-size: 14px;">
                <small>触发词：
                    ...
                    <span class="label label-danger input-icon-tag-tip-4" style="text-shadow: none;display: none">请认真填写，审核后才能发布</span>
                    &nbsp;
                </small>
            </li>
        </ul>
            ...
            $('pre').mouseup(function(e){
                ...
                if (1 == e.which && push_tag!="" &&event_sign) {
                    swal({
                        ...
                        if (isConfirm) {
                            $.ajax({
                                url: "${pageContext.request.contextPath}/Show/News/Detail/submit",
                                type: 'POST',
                                dataType: 'JSON',
                                data: {
                                    "catelogid": myvalue,
