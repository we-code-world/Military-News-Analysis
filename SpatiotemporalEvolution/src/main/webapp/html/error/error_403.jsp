...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="col-md-12">
          <div class="col-middle">
            <div class="text-center text-center">
              ...
              <h2>对不起，访问失败</h2>
              <p>访问此资源需要完全身份验证！  <a href="${pageContext.request.contextPath}/">反馈一下？</a>
              </p>
   ...
   <script src="${pageContext.request.contextPath}/js/backstage/bootstrap.bundle.min.js"></script>
    <!-- FastClick -->
    <script src="${pageContext.request.contextPath}/js/backstage/fastclick.js"></script>
    <!-- NProgress -->
    <script src="${pageContext.request.contextPath}/js/backstage/nprogress.js"></script>

    <!-- Custom Theme Scripts -->
    <script src="${pageContext.request.contextPath}/js/backstage/custom.min.js"></script>
  </body>
</html>