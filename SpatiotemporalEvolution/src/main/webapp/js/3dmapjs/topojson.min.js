!function(){
        ...
        return t.forEach(function(r,e){
            ...
            t.forEach(function(n){
                ...
                if(t=u[f])
                    ...
                    e(u,i),e(i,u),
                    t.forEach(function(n){
                        o[0>n?~n:n]||f.push([n])}),f
                    }
                    function r(n,r,e){
                        function o(n){
                            var t=0>n?~n:n;(s[t]||(s[t]=[])).push({i:n,g:a})
                        }
                        function i(n){
                            n.forEach(o)
                        }
                        ...
                        function f(n){
                            "GeometryCollection"===n.type?n.geometries.forEach(f):n.type in l&&(a=n,l[n.type](n.arcs))}var c=[];
                        if(arguments.length>1){
                            var a,s=[],l={LineString:i,MultiLineString:u,Polygon:u,MultiPolygon:function(n){
                                n.forEach(u)}};f(r),s.forEach(arguments.length<3?function(n){
                                    c.push(n[0].i)
                                }:function(n){
                            ...
                            for(var h=0,p=n.arcs.length;p>h;++h)
                                c.push(h);
                            return{
                                type:"MultiLineString",arcs:t(n,c)
                            }
    }
    function e(r,e){
        function o(n){
        ...
        return"GeometryCollection"===t.type?{type:"FeatureCollection",
    ...
    function i(n,t){
        ...
        function r(n,t){
            ...
            for(var r,e=s[0>n?~n:n],o=0,i=e.length;i>o;++o)
                t.push(r=e[o].slice()),a(r,o);0>n&&f(t,i)
        }
        function e(n){
        ...
        function u(n){
            ...
            var t=n.type;
            return"GeometryCollection"===t?{type:t,geometries:n.geometries.map(c)}:t in l?{type:t,coordinates:l[t](n)}:null
        }
        var a=g(n.transform),s=n.arcs,l={Point:function(n){
    ...
    function a(n){
        ...
        function r(n,r){
            n.forEach(function(n){t(n,r)})
        }function e(n,t){
            "GeometryCollection"===n.type?n.geometries.forEach(function(n){
                e(n,t)}):n.type in u&&u[n.type](n.arcs,t)
        }
        var o={},i=n.map(function(){
            return[]
        }),u={LineString:t,MultiLineString:r,Polygon:r,MultiPolygon:function(n,t){
    ...
    function s(n,t){
        ...
        var e=g(n.transform),o=m(n.transform),i=v();
        return t||(t=h),n.arcs.forEach(function(n){
            var u,f=[],c=0;n.forEach(e);
            for(var a=1,s=n.length-1;s>a;++a)
                u=n.slice(a-1,a+2),u[1][2]=t(u),f.push(u),i.push(u);
            n[0][2]=n[s][2]=1/0;
            for(var a=0,s=f.length;
                s>a;++a)u=f[a],u.previous=f[a-1],u.next=f[a+1];
            for(;u=i.pop();){
                var l=u.previous,h=u.next;
                u[1][2]<c?u[1][2]=c:c=u[1][2],l&&(l.next=h,l[2]=u[2],r(l)),h&&(h.previous=l,h[0]=u[0],r(h))
            }
            n.forEach(o)
        }),n
    }
    function l(n){
        for(var t,r=-1,e=n.length,o=n[e-1],i=0;++r<e;)
            t=o,o=n[r],i+=t[0]*o[1]-t[1]*o[0];return.5*i
    }
    function h(n){
    ...
    function v(){
        ...
        function t(n,t){
            for(;;){
                ...
                if(o>i&&p(e[i],f)<0&&(f=e[u=i]),o>r&&p(e[r],f)<0&&(f=e[u=r]),u===t)
                    break;
        ...
        return r.push=function(t){
            ...
            var i,u=r._;
            if(e[u]===r)
                return u!==--o&&(i=e[o],(p(i,r)<0?n:t)(e[i._=u]=i,u)),u
        },r
    }
    function g(n){
        if(!n)return y;
    ...
    function y(){}
    var d={version:"1.6.15",mesh:function(n){
